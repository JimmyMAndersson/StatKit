...
extension UniformDistributionTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__UniformDistributionTests = [
        ("testCDF", testCDF),
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(UniformDistributionTests.__allTests__UniformDistributionTests),
