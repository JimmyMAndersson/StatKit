...
final class ModifiedCompetitionRankingTests: XCTestCase {
  func testDistinctDataSetByDescendingOrder() {
    ...
    let calculatedRank = rank(intArray, variable: \.self, by: >, strategy: .modifiedCompetition)
  ...
  func testIndistinctDataSetByDescendingOrder() {
    ...
    let calculatedRank = rank(fpArray, variable: \.self, by: >, strategy: .modifiedCompetition)
