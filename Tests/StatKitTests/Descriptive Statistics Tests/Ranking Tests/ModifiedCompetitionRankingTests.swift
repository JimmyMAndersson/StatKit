...
final class ModifiedCompetitionRankingTests: XCTestCase {
  func testDistinctDataSetByDescendingOrder() {
    ...
    let calculatedRank = intArray.rank(variable: \.self, by: >, strategy: .modifiedCompetition)
  ...
  func testIndistinctDataSetByDescendingOrder() {
    ...
    let calculatedRank = fpArray.rank(variable: \.self, by: >, strategy: .modifiedCompetition)
