...
private extension Collection {  
  ...
  func countTieRanks<T>(of X: KeyPath<Element, T>) -> Int where T: Hashable {
  ...
  func discordantPairs<T, U>(
    of X: KeyPath<Element, T>,
    and Y: KeyPath<Self.Element, U>) -> Int
    where
    T: Comparable,
    U: Comparable {
...
private extension ArraySlice {
  ...
  mutating func computeDiscordance<T>(
    sorting Y: KeyPath<Element, T>) -> Int
    where T: Comparable {
  ...
  /// - returns: The number of discordant pairs found in the collection.
  private mutating func countDiscordantPairs<T>(
    sorting Y: KeyPath<Self.Element, T>) -> Int
    where T: Comparable {
